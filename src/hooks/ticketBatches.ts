...
const ticketBatches: Array<TicketBatch> = [
    new TicketBatch({ description: 'Kit', firstSaleDate: new Date('2022-11-01'), finalSaleDate: new Date('2022-11-21'), title: '3º Lote', link: 'https://doity.com.br/devfest-cerrado-2022#registration', value: 130 }),
